...
Page {
    ...
    // Persist volume / speed / muted / loop across sessions
    Settings {
        id: persisted
        category: "player"
    ...
    Connections {
        ...
        function onFileSelected(path) { root.openFile(path) }
    }
    ...
    DropArea {
        ...
        onDropped: function(drop) {
            if (drop.hasUrls && drop.urls.length > 0) {
                ...
                root.openFile(url.startsWith("file://") ? url.slice(7) : url)
                drop.accept()
            }
        }
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            BasicButtonType {
                ...
                text: root.hasVideo ? qsTr("Change video") : qsTr("Upload video")
                font.pixelSize: 13
                font.weight: Font.DemiBold
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            Text {
                Layout.alignment: Qt.AlignHCenter
                text: qsTr("Click \u201CUpload video\u201D or drop a file here")
        ...
        // Telegram-style double-tap seek zones + volume wheel + click-to-toggle
        MouseArea {
            id: stageMouse
            anchors.fill: parent
            hoverEnabled: true
        ...
        // Skip indicators (Telegram-style)
        SkipIndicator {
            id: skipLeft
            direction: -1
            anchors.left: parent.left
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    // Frame back / forward (visible when paused only)
                    CircleButton {
